...
// Wasca cartridge assembly test
#define REG_WASCA_SYS_DATAT1 (*(volatile unsigned short*)(0x23FFFFE0)) // FFFF
#define REG_WASCA_SYS_DATAT2 (*(volatile unsigned short*)(0x23FFFFE2)) // 0000
#define REG_WASCA_SYS_DATAT3 (*(volatile unsigned short*)(0x23FFFFE4)) // A5A5
#define REG_WASCA_SYS_DATAT4 (*(volatile unsigned short*)(0x23FFFFE6)) // 5A5A
// 0x23FFFFE8 : x"CA" & rd_access_cntr
// 0x23FFFFEA : x"AC" & rd_access_cntr
// 0x23FFFFEC : x"FE" & wr_access_cntr
// 0x23FFFFEE : x"EF" & wr_access_cntr
