...
//    if(UART_0_FREQ <= ((45158001/2) + 50000))
//    {
//        /* MAX 10 Board r0.7b : limited PLL output frequency, 
//         * which doesn't allows UART to run at usual baud rate.
//         * As a simple countermeasure, baud rate have to be set
//         * at 1/4 speed from usual = 230400 bps.
//         */
//        ((unsigned long*)UART_0_BASE)[4] = 98; // 22579000/230400 + 0.5 = 98.49913194
//    }
//    else if(UART_0_FREQ <= (45158001 + 50000))
//    {
//        /* MAX 10 Board r0.7b : limited PLL output frequency, 
//         * which doesn't allows UART to run at usual baud rate.
//         * As a simple countermeasure, baud rate have to be set
//         * at half speed from usual = 460800 bps.
//         */
//        ((unsigned long*)UART_0_BASE)[4] = 0x00000064; //  460800 bps (0x0000007E / 2.5 * 2)
//    }
//    else
    {
