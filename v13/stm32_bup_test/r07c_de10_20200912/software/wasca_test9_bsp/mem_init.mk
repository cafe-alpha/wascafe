...
$(MEM_1)_END := 0x0015ffff
$(MEM_1)_SPAN := 0x00160000
...
$(HDL_SIM_DIR)/$(MEM_1).dat: $(MEM_1).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x15ffff --width=$(mem_width) \
...
MEM_3 := wasca_onchip_memory2_1
$(MEM_3)_NAME := onchip_memory2_1
...
$(MEM_3)_START := 0x0c000000
$(MEM_3)_END := 0x0c000fff
$(MEM_3)_SPAN := 0x00001000
$(MEM_3)_HIERARCHICAL_PATH := onchip_memory2_1
$(MEM_3)_WIDTH := 32
...
onchip_memory2_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_3).hex $(HDL_SIM_DIR)/$(MEM_3).dat $(HDL_SIM_DIR)/$(MEM_3).sym
